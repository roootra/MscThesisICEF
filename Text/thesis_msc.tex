...
\begin{table}[h!]
	...
	\caption{Identification restrictions used to recover structural shocks. Positive (negative) signs describe non-strictly positive (negative) restrictions for variable's contemporaneous and next quarter response to a particular shock. Zero indicates no contemporaneous reaction.}
...
\begin{table}[h!!]
	...
	\begin{tabular}{@{}lllll@{}}
		...
		Supply shock            & -0.2389         & -0.1239          & -0.3556         & -0.3907         \\ % & -0.2389         & -0.0239          & -0.3556         & -0.3907         \\
