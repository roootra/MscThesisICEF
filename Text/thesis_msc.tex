...
See Table \ref{table:variables_decription} for data description and sources, Table \ref{table:correlation_variables} for correlation matrix of variables.
...
\begin{table}[h!]
	...
	%\resizebox{\textwidth}{!}{%
		\begin{tabular}{@{}lll@{}}
			...
			Exchange rate & \makecell[l]{Nominal effective exchange rate (NEER) of ruble, \\MoM, Central Bank of Russia methodology} & CBR        \\
	...
	\begin{tabular}{rllllll}
	 ...
	 & Oil price & Import price & MIACR & NEER & GDP & CPI \\ 
	  \midrule
	   ...
	   \bottomrule
	\end{tabular}
	\caption{Correlation table of variables, growth rates where applicable.\\ $^*p<0.05,\; ^{**}p<0.01,\;^{***}p<0.001$.}
