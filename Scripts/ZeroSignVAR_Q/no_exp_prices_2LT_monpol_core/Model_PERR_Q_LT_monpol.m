...
opt.lVars = {'gdp_real_qoq', 'cpi_core_qoq', 'miacr_31','neer_qoq', 'oil_USD_qoq'}; %a-la Forbes et al. 2018
...
%PERR Median
%%% PERR Calculation
perr_gdp = sum(output.irfMedian(1:4,6))/sum(output.irfMedian(1:4,16));
perr_cpi = sum(output.irfMedian(1:4,7))/sum(output.irfMedian(1:4,17));
perr_int = sum(output.irfMedian(1:4,8))/sum(output.irfMedian(1:4,18));
perr_neer = sum(output.irfMedian(1:4,9))/sum(output.irfMedian(1:4,19));
perr_oil = sum(output.irfMedian(1:4,10))/sum(output.irfMedian(1:4,20));
sprintf("MEDIAN")
sprintf("PERRs (4q):\n")
sprintf("Oil shock: %0.5f", perr_oil)
sprintf("Monetary shock: %0.5f", perr_int)
...
perr_gdp_s = sum(output.irfMedian(1,6))/sum(output.irfMedian(1,16));
perr_cpi_s = sum(output.irfMedian(1,7))/sum(output.irfMedian(1,17));
perr_int_s = sum(output.irfMedian(1,8))/sum(output.irfMedian(1,18));
perr_neer_s = sum(output.irfMedian(1,9))/sum(output.irfMedian(1,19));
perr_oil_s = sum(output.irfMedian(1,10))/sum(output.irfMedian(1,20));
