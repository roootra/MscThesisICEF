...
opt.lVars = {'Real GDP QoQ', 'CPI QoQ', 'MIACR 31-180 q avg', 'NEER QoQ', 'World export prices QoQ','Oil price QoQ'}; %a-la Forbes et al. 2018
...
opt.lShocks = {'Supply shock', 'Demand shock', 'Monetary shock', 'Exchange rate shock', 'Global price shock', 'Oil price shock'};
