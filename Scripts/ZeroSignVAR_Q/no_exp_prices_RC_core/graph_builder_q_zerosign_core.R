...
### IRF
irf_mat <- import("/Users/rutra/ВШЭ/Магистратура/Thesis/Scripts/ZeroSignVAR_Q/no_exp_prices_RC_core/Model_PERR_Q_rc_core/tables/irfs.mat")
...
ggsave(filename="irf_core_1.eps",
       path="/Users/rutra/ВШЭ/Магистратура/Thesis/Text/figures/",
       device="eps",
       width=320, height=210, dpi=320, units = "mm", limitsize=FALSE)
...
ggsave(filename="irf_core_2.eps",
         path="/Users/rutra/ВШЭ/Магистратура/Thesis/Text/figures/",
         device="eps",
         width=320, height=210, dpi=320, units = "mm", limitsize=FALSE)
...
hd_mat <- import("/Users/rutra/ВШЭ/Магистратура/Thesis/Scripts/ZeroSignVAR_Q/no_exp_prices_RC_core/Model_PERR_Q_rc_core/tables/HistDecompCTM.mat")
...
ggsave(filename="hd_core_cpi_full.eps",
       path="/Users/rutra/ВШЭ/Магистратура/Thesis/Text/figures/",
       device="eps",
       width=320, height=210, dpi=320, units = "mm", limitsize=FALSE)
...
ggsave(filename="hd_core_cpi_cut.eps",
       path="/Users/rutra/ВШЭ/Магистратура/Thesis/Text/figures/",
       device="eps",
       width=320, height=210, dpi=320, units = "mm", limitsize=FALSE)
