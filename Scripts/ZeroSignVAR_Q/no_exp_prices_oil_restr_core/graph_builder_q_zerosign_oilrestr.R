...
### IRF
irf_mat <- import("/Users/rutra/ВШЭ/Магистратура/Thesis/Scripts/ZeroSignVAR_Q/no_exp_prices_oil_restr_core/Model_PERR_Q_oilrestr/tables/irfs.mat")
...
ggsave(filename="irf_oilrestr_1_core.eps",
       path="/Users/rutra/ВШЭ/Магистратура/Thesis/Text/figures/",
       device="eps",
       width=320, height=210, dpi=320, units = "mm", limitsize=FALSE)
...
ggsave(filename="irf_oilrestr_2_core.eps",
         path="/Users/rutra/ВШЭ/Магистратура/Thesis/Text/figures/",
         device="eps",
         width=320, height=210, dpi=320, units = "mm", limitsize=FALSE)
...
hd_mat <- import("/Users/rutra/ВШЭ/Магистратура/Thesis/Scripts/ZeroSignVAR_Q/no_exp_prices_oil_restr_core/Model_PERR_Q_oilrestr/tables/HistDecompCTM.mat")
...
ggsave(filename="hd_cpi_oilrestr_cut_core.eps",
       path="/Users/rutra/ВШЭ/Магистратура/Thesis/Text/figures/",
       device="eps",
       width=320, height=210, dpi=320, units = "mm", limitsize=FALSE)
