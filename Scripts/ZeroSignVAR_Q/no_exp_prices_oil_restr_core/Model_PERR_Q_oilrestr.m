...
opt.modelName = 'Model_PERR_Q_oilrestr';     
...
opt.lVars = {'gdpRealQoq', 'cpiCoreQoq', 'miacr31','neerQoq', 'oilUSDQoq'}; %a-la Forbes et al. 2018
...
%Oil price shock (Kreptsev & Seleznev 2016)
S(1,5,5) = 1
S(3,10,5) = 1
S(2,4,5) = -1
S(3,1,5) = 1 %gdp
