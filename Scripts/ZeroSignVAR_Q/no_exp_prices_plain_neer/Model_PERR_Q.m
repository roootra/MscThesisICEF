...
S(5,6,2) = 1
S(6,4,2) = 1 %NEER response (problematic)
S(7,9,2) = 1

%Monetary shock
S(1,3,3) = 1 %interest rate response
S(8,8,3) = 1
...
%Ex. rate shock
S(1,4,4) = 1 %ex rate response
S(4,9,4) = 1
S(2,2,4) = -1 %cpi response
S(3,7,4) = -1
Z(1,5 + nVars*0,4) = 1
%Z(2,5 + nVars*1,4) = 1
%Z(3,5 + nVars*2,4) = 1
...
%Oil price shock
S(1,5,5) = 1 %oil response
S(3,10,5) = 1 %oil response
S(2,4,5) = 1 %neer response
S(4,9,5) = 1 %??? (TEST)
